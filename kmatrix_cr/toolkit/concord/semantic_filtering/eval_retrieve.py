...
from kmatrix_cr.toolkit.concord.semantic_filtering.utils import chunks, find_encapsulating_sentence, extract_context_from_nq, extract_answer_from_nq, qualify_context, metric_max_over_ground_truths, f1_score
...
def main(args):
    ...
    qac_mod = qa_converter.QAConverter(model_weights_path=args.model_weights_path)
    ...
    nq_dev = load_dataset('natural_questions', 'dev', cache_dir=args.cache_dir)

    if args.split == "test":
        nq_dev_inds = readable_indices["test"]
    else:
        nq_dev_inds = readable_indices["val"]
