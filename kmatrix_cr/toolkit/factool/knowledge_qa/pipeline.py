...
from kmatrix_cr.toolkit.factool.knowledge_qa.tool import google_search,local_search,input_search
from kmatrix_cr.toolkit.factool.utils.base.pipeline import pipeline

class knowledge_qa_pipeline(pipeline):
    def __init__(self, foundation_model, snippet_cnt, search_type, data_link=None, Embed_link=None,data_list=[]):
        ...
        if(search_type == 'online'):
            ...
            self.tool = input_search(snippet_cnt = snippet_cnt,data_list=self.data_list)
